...
//
// Contains console printer for CMPS12B HW1
// 
// Compile 
...
//
// where <FILE> is a file for the solution of CMPS12B HW1 (placing N queens on a chessboard, with some twists to the input).
//
...
class PrintSolutionHelper {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            BufferedReader solution = new BufferedReader(new FileReader(args[0]));
            // call the respective methods to read from file and display the chessboard

            String line; // store each line in input file
            int line_no = -1;

            while ((line = solution.readLine()) != null) { // reading in line, and checking if file has ended
