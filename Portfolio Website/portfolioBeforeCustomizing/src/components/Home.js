    ...
    <main>
      ...
      <section className="relative flex justify-center min-h-screen pt-1 px-8">
        <div className="text-lg flex flex-col justify-center">
          <h1 className="text-4xl lightBlue font-bold cursive leading-none lg:leading-snug home-name">
            I'm Claire
          </h1>
          <h4 className="text-4xl midBlue font-bold cursive leading-none lg:leading-snug">
